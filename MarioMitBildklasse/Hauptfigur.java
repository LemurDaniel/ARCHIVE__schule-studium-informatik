...
public class Hauptfigur
{
    ...
    public Hauptfigur(int x, int y)
    {
        Lauftimer = new Timer(1, new ActionListener()
         ...
         Figur = new Bild("pic/test.jpg",x,y);
...
//              
    ...
    public void LaufenStop(){
      ...
      public void lauf(int zeit, int Geschwindigkeit){
        ...
        int newposx = vx * zeit;   
            ...
            Figur.x=Figur.x-newposx;
            Figur.positioniereBild(Figur.pic,Figur.x,Figur.y);
            }
   ...
   public void springhoch(int zeit, int Geschwindigkeit, int maxSprunghoehe){
        ...
        if(y==maxSprunghoehe){
                ...
                Figur.y=Figur.y+newposy;
                Figur.positioniereBild(Figur.pic,Figur.x,newposy);
                }
        }
   }

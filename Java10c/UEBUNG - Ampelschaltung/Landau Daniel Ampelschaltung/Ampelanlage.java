...
class Ampelanlage
{
    ...
    public void loesche()
    {
        for (int i=0;i<4;i++)
        {
            Ampeln[i].loescheAmpel();
        }
        for (int i=0;i<8;i++)
        {
            FussgaengerAmpeln[i].loescheAmpel();
        }
        Querstrasse.loescheRechteck();
        Laengsstrasse.loescheRechteck();
    }
	
	public void zeichne(){
		for (int i=0;i<4;i++)
        {
            Ampeln[i].zeichneAmpel();
        }
        for (int i=0;i<8;i++)
        {
            FussgaengerAmpeln[i].zeichneAmpel();
        }
		Querstrasse.zeichne();
        Laengsstrasse.zeichne();
	}

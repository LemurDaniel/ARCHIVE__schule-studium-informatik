...
public class Ampel
{
    ...
    {        
        switch (position)
        {
            ...
            Signale[2] = new VOLLKREIS(links+breite+rand,oben+breite+rand,breite,2); // Lichter alle mit gleichem Links-Wert 
            Signale[1] = new VOLLKREIS(links+breite+rand,oben+3*breite+2*rand,breite,6);
            Signale[0] = new VOLLKREIS(links+breite+rand,oben+5*breite+3*rand,breite,4); 
            break;
            ...
            Signale[2]= new VOLLKREIS(links+breite+rand,oben+breite+rand,breite,2); // Lichter: rot unten
            Signale[1]= new VOLLKREIS(links+3*breite+2*rand,oben+breite+rand,breite,6);
            Signale[0]= new VOLLKREIS(links+5*breite+3*rand,oben+breite+rand,breite,4);
            break;

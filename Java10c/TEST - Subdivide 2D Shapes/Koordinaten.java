...
public class Koordinaten
{
    ...
    public Koordinaten(float x, float y, boolean ML){
        Xpos = x;
        Ypos = y;
        if(ML){add_mouseListener();};
    }
    ...
    public void disable_mouseListener(){
        MouseListener = false;
    }
         ...
         Zeich.addMouseListener(new MouseAdapter(){  
                ...
                public void mouseClicked(MouseEvent e){ 
                    if(MouseListener){
                        if(MouseClick){
                            print();
                            //int X = ZEICHENFENSTER.gibFenster().gibMousePosX();
                            //int Y = ZEICHENFENSTER.gibFenster().gibMousePosY();
                        ...
                        System.out.println("mouseClicked Zeich");
                    }  
                }

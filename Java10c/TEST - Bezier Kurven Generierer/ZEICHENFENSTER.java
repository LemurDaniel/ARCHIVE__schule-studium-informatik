...
public class ZEICHENFENSTER
{
	...
	public JPanel gibSteuerungSued(){
		return steuerungSued;
	}
    ...
    {
        this(titel, 2048, 1028, Color.white);   
    }
    ...
    public int gibMousePosX(){
        return MouseX;
    }
    
    public int gibMousePosY(){
        return MouseY;
    }
     ...
     */
    public void zeichneStrecke(int x1, int y1, int x2, int y2, String farbe)
    {
        Color original = graphic.getColor();
        graphic.setColor(farbeZuColor(farbe));
    ...
    private Color farbeZuColor(String farbe)
    {
        ...
        if (farbe=="orange") return new Color(255,128,0);
        if (farbe=="hellgruen") return new Color(0,255,255);
        if (farbe=="hellgrau") return new Color(190,190,190);
        if (farbe=="hellblau") return new Color(0,128,255);

...
<head>
<meta charset="utf-8">
<title>PHP 16 - DB schreiben/lesen</title>
</head>
...
<?php
	...
	$sql = "Insert into teilnehmer (Name, Vorname, Ort, Email, Bild1, Bild2) Values ('Cheeks', 'Sandy', 'Bikini Bottom', 'Sandy@gmail.com', 'Haselnuss', 'Unterwasserkupel');";
	if(!$mysql->query($sql)){
		echo "<br><br> <h1>";

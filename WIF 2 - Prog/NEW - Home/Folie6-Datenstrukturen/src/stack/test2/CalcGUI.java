...
public class CalcGUI extends JFrame {
	...
	public static void main(String[] args) {
		...
		fenster.setBounds(500, 250, 570, 490);
	}
		...
		if (btnCheck == null) {
			...
			btnCheck.addActionListener(arg0 -> {
				try {
					...
					stack.calcExp(tFpassword.getText(), arg1 -> textArea2.append(arg1));
	...
	private JScrollPane getScrollPane() {
		if (scrollPane == null) {
			...
			scrollPane.setBounds(29, 224, 487, 215);
		...
		if (btnPush == null) {
			...
			btnPush.addActionListener(arg0->{
				try {
					...
					textArea.setText(null);
					stack.calcExp(tFpassword.getText(), cr-> textArea2.append(cr));
					textArea.append("Expression\n -> "+tFpassword.getText()+"\n");
	...
	private JRadioButton getRdbtnNewRadioButton() {
		if (rdbtnNewRadioButton == null) {
			rdbtnNewRadioButton = new JRadioButton("Polish Notation");
			buttonGroup.add(rdbtnNewRadioButton);
			rdbtnNewRadioButton.setFont(new Font("Dialog", Font.BOLD, 13));
			rdbtnNewRadioButton.setBounds(30, 179, 138, 23);
			rdbtnNewRadioButton.addActionListener(l->{
				if(rdbtnNewRadioButton.isSelected()) stack.setModus(StackR.PolishNotation);
			});
		}
	...
	private JRadioButton getRdbtnReversePolishNotation() {
		if (rdbtnReversePolishNotation == null) {
			...
			rdbtnReversePolishNotation.setBounds(318, 179, 198, 23);
			rdbtnReversePolishNotation.addActionListener(l->{
				if(rdbtnReversePolishNotation.isSelected()) stack.setModus(StackR.ReversePolishNotation);
			});
		}
	...
	private JRadioButton getRdbtnNewRadioButton_1() {
		if (rdbtnNewRadioButton_1 == null) {
			...
			rdbtnNewRadioButton_1.setBounds(186, 179, 109, 23);

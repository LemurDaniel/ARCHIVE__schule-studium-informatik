...
public class Liste_Raw_GUI extends JFrame {
	...
	private Liste liste = new Liste(3);
	
	public Liste_Raw_GUI() {
		setTitle("Liste raw type");
		...
		if (btnNewButton == null) {
			...
			btnNewButton.addActionListener(l->{
				...
				try {
					...
					JOptionPane.showMessageDialog(Liste_Raw_GUI.this, "Fehler");
				}
			});
		}
		return btnNewButton;

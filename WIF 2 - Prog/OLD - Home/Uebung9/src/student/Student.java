...
public class Student implements Comparable<Student>, Serializable{
	...
	private IntegerProperty martrikelNr;
	private StringProperty name;
	private IntegerProperty  ects, semester;
	
	public Student(int martrikelNr, int ects, int semester, String name){
		this.martrikelNr = new SimpleIntegerProperty();
	...
	public IntegerProperty getEcts() {
		return ects;
	}
	public IntegerProperty getSemester() {
		return semester;
	}
	public IntegerProperty getMartrikelNr() {
		return martrikelNr;
	}

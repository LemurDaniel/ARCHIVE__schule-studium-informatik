...
public class CalcGUI extends JFrame {
	...
	public static void main(String[] args) {
		...
		System.out.println("Load Test: 0 Test  // '0' can be any number in range [0, 9] // eval test with '=' ");
		System.out.println("");
		System.out.println("Map maxint to mx: (maxint) (mx) mapto ");
		System.out.println("Create shorthand term1 for expression: (term1) (2 2 +) map ");
		System.out.println("Create shorthand term2 for expression: (term2) (2 2 +) map ");
		System.out.println("");
		System.out.println("Use shorthand: term1 ==> 4");
		System.out.println("Use shorthand: term2 ==> (2 2 +)");
		System.out.println("");
		System.out.println("Enter Expression: (2 2 +)  ");
		System.out.println("Enter Expression than eval: (2 2 +) = ");
		System.out.println("");
		System.out.println("Convert 5 to bigint:  5 bigint");
		System.out.println("Evaluate a logical expression: (2 10 <) (12 12 ==) & (3 3 <) |");

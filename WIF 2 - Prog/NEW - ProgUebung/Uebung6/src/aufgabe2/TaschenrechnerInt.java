...
public class TaschenrechnerInt extends JFrame {
	...
	public static void main(String[] args) {
		TaschenrechnerInt t = new TaschenrechnerInt();
		t.setVisible(true);
		...
		if (btnBerechne == null) {
			...
			btnBerechne.addActionListener(e -> {
				try {
					...
					tFerg.setText( berechneInt(tFe1, tFe2, list.getSelectedItem())+"" );
	...
	public int berechneInt(JTextField tfArg1, JTextField tfArg2, String operation) throws Exception{
		int num1, num2, erg;
		
		//try {
			num1 = Integer.parseInt(tfArg1.getText());
			num2 = Integer.parseInt(tfArg2.getText());

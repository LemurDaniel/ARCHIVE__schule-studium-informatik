...
public class FensterManager {
	...
	public static HauptseiteCtrl getHauptSeiteCtrl() {
		if (hauptseiteCtrl == null) getHauptSeite();
		return hauptseiteCtrl;
	}
...
//	private static ListensichtCtrl listensichtCtrl;
	...
	public static Stage getHauptSeite() {
		if(hauptseite==null) {
			...
			hauptseite.setHeight(600);
			hauptseite.setWidth(1700);
...
//		});
	...
	public static void showStatusmeldung() {
		if(statusmeldung==null) {
			...
			statusmeldung.getDialogPane().setPrefHeight(340);

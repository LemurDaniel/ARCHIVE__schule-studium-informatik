...
public class AnmeldeseiteCtrl {
    ...
    private String name = "";
    private String pwd="";
	private String pwdDaniel="DasPasswort";
	private String pwdAlleRechte="]TrPCLPJ2T''XH.)Pn^l'{L{JT9\\tEwO=<b%%F/Jq7T:pi2Z9g";
    ...
    void btnAction(ActionEvent event) {
    	...
    	try{
    		...
    		else if(i==3) Nutzer.anmeldenKonto("Daniel", pwdDaniel);
    		else if(i==4) Nutzer.anmeldenKonto("Alle Rechte", pwdAlleRechte);
	...
	private void trozdemAnmelden() {
		...
		b.setOnCloseRequest(evb->{
			if(b.getResult().getButtonData().equals(ButtonData.OK_DONE)) {
				try {
					Nutzer.getNutzer().vonAnderenInstanzenAbmelden(tf_name.getText().trim(), pwd);
				} 

...
public class Hauptfigur
{
    ...
    public Hauptfigur()
    {
      ...
      Pixel[46]= new RECHTECK(x+2*breite,y-5*breite,breite,breite,"rot"); //6 Reihe von unten des rechten Fuﬂes 3 Pixel von links aus gez‰hlt
      ...
      Pixel[53]= new RECHTECK(x+9*breite,y-5*breite,breite,breite,"rot"); //6 Reihe von unten des rechten Fuﬂes 10 Pixel von links aus gez‰hlt
      ...
      Pixel[56]= new RECHTECK(x,y-6*breite,breite,breite,"rot"); //7 Reihe von unten des rechten Fuﬂes 1 Pixel von links aus gez‰hlt
      Pixel[57]= new RECHTECK(x+1*breite,y-6*breite,breite,breite,"rot"); //7 Reihe von unten des rechten Fuﬂes 2 Pixel von links aus gez‰hlt
      Pixel[58]= new RECHTECK(x+2*breite,y-6*breite,breite,breite,"rot"); //7 Reihe von unten des rechten Fuﬂes 3 Pixel von links aus gez‰hlt
      Pixel[59]= new RECHTECK(x+3*breite,y-6*breite,breite,breite,"rot"); //7 Reihe von unten des rechten Fuﬂes 4 Pixel von links aus gez‰hlt
      ...
      Pixel[64]= new RECHTECK(x+8*breite,y-6*breite,breite,breite,"rot"); //7 Reihe von unten des rechten Fuﬂes 9 Pixel von links aus gez‰hlt
      Pixel[65]= new RECHTECK(x+9*breite,y-6*breite,breite,breite,"rot"); //7 Reihe von unten des rechten Fuﬂes 10 Pixel von links aus gez‰hlt
      Pixel[66]= new RECHTECK(x+10*breite,y-6*breite,breite,breite,"rot"); //7 Reihe von unten des rechten Fuﬂes 11 Pixel von links aus gez‰hlt
      Pixel[67]= new RECHTECK(x+11*breite,y-6*breite,breite,breite,"rot"); //7 Reihe von unten des rechten Fuﬂes 12 Pixel von links aus gez‰hlt
      
      
      Pixel[68]= new RECHTECK(x+1*breite,y-7*breite,breite,breite,"rot"); //8 Reihe von unten des rechten Fuﬂes 1 Pixel von links aus gez‰hlt
      Pixel[69]= new RECHTECK(x+2*breite,y-7*breite,breite,breite,"rot"); //8 Reihe von unten des rechten Fuﬂes 2 Pixel von links aus gez‰hlt
      Pixel[70]= new RECHTECK(x+3*breite,y-7*breite,breite,breite,"rot"); //8 Reihe von unten des rechten Fuﬂes 3 Pixel von links aus gez‰hlt
      ...
      Pixel[72]= new RECHTECK(x+5*breite,y-7*breite,breite,breite,"rot"); //8 Reihe von unten des rechten Fuﬂes 5 Pixel von links aus gez‰hlt
      Pixel[73]= new RECHTECK(x+6*breite,y-7*breite,breite,breite,"rot"); //8 Reihe von unten des rechten Fuﬂes 6 Pixel von links aus gez‰hlt
      ...
      Pixel[75]= new RECHTECK(x+8*breite,y-7*breite,breite,breite,"rot"); //8 Reihe von unten des rechten Fuﬂes 8 Pixel von links aus gez‰hlt
      Pixel[76]= new RECHTECK(x+9*breite,y-7*breite,breite,breite,"rot"); //8 Reihe von unten des rechten Fuﬂes 9 Pixel von links aus gez‰hlt
      Pixel[77]= new RECHTECK(x+10*breite,y-7*breite,breite,breite,"rot"); //8 Reihe von unten des rechten Fuﬂes 10 Pixel von links aus gez‰hlt
            
      Pixel[78]= new RECHTECK(x+2*breite,y-8*breite,breite,breite,"rot"); //9 Reihe von unten des rechten Fuﬂes 1 Pixel von links aus gez‰hlt
      Pixel[79]= new RECHTECK(x+3*breite,y-8*breite,breite,breite,"rot"); //9 Reihe von unten des rechten Fuﬂes 2 Pixel von links aus gez‰hlt
      ...
      Pixel[81]= new RECHTECK(x+5*breite,y-8*breite,breite,breite,"rot"); //9 Reihe von unten des rechten Fuﬂes 4 Pixel von links aus gez‰hlt
      Pixel[82]= new RECHTECK(x+6*breite,y-8*breite,breite,breite,"rot"); //9 Reihe von unten des rechten Fuﬂes 5 Pixel von links aus gez‰hlt
      Pixel[83]= new RECHTECK(x+7*breite,y-8*breite,breite,breite,"rot"); //9 Reihe von unten des rechten Fuﬂes 6 Pixel von links aus gez‰hlt
      Pixel[84]= new RECHTECK(x+8*breite,y-8*breite,breite,breite,"rot"); //9 Reihe von unten des rechten Fuﬂes 7 Pixel von links aus gez‰hlt
      ...
      Pixel[119]= new RECHTECK(x+2*breite,y-14*breite,breite,breite,"rot"); //15 Reihe von unten des rechten Fuﬂes 1 Pixel von links aus gez‰hlt 
      Pixel[120]= new RECHTECK(x+3*breite,y-14*breite,breite,breite,"rot"); //15 Reihe von unten des rechten Fuﬂes 2 Pixel von links aus gez‰hlt
      Pixel[121]= new RECHTECK(x+4*breite,y-14*breite,breite,breite,"rot"); //15 Reihe von unten des rechten Fuﬂes 3 Pixel von links aus gez‰hlt
      Pixel[122]= new RECHTECK(x+5*breite,y-14*breite,breite,breite,"rot"); //15 Reihe von unten des rechten Fuﬂes 4 Pixel von links aus gez‰hlt
      Pixel[123]= new RECHTECK(x+6*breite,y-14*breite,breite,breite,"rot"); //15 Reihe von unten des rechten Fuﬂes 5 Pixel von links aus gez‰hlt
      Pixel[124]= new RECHTECK(x+7*breite,y-14*breite,breite,breite,"rot"); //15 Reihe von unten des rechten Fuﬂes 6 Pixel von links aus gez‰hlt
      Pixel[125]= new RECHTECK(x+8*breite,y-14*breite,breite,breite,"rot"); //15 Reihe von unten des rechten Fuﬂes 7 Pixel von links aus gez‰hlt
      Pixel[126]= new RECHTECK(x+9*breite,y-14*breite,breite,breite,"rot"); //15 Reihe von unten des rechten Fuﬂes 8 Pixel von links aus gez‰hlt
      Pixel[127]= new RECHTECK(x+10*breite,y-14*breite,breite,breite,"rot"); //15 Reihe von unten des rechten Fuﬂes 9 Pixel von links aus gez‰hlt
                  
      Pixel[128]= new RECHTECK(x+3*breite,y-15*breite,breite,breite,"rot"); //16 Reihe von unten des rechten Fuﬂes 2 Pixel von links aus gez‰hlt
      Pixel[129]= new RECHTECK(x+4*breite,y-15*breite,breite,breite,"rot"); //16 Reihe von unten des rechten Fuﬂes 3 Pixel von links aus gez‰hlt
      Pixel[130]= new RECHTECK(x+5*breite,y-15*breite,breite,breite,"rot"); //16 Reihe von unten des rechten Fuﬂes 4 Pixel von links aus gez‰hlt
      Pixel[131]= new RECHTECK(x+6*breite,y-15*breite,breite,breite,"rot"); //16 Reihe von unten des rechten Fuﬂes 5 Pixel von links aus gez‰hlt
      Pixel[132]= new RECHTECK(x+7*breite,y-15*breite,breite,breite,"rot"); //16 Reihe von unten des rechten Fuﬂes 6 Pixel von links aus gez‰hlt
